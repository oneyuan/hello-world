...
class FUCK():
    ...
    def _get_order_url(self):
        return "http://yuyue.juneberry.cn/BookSeat/BookSeatMessage.aspx?seatNo=101002" + self.seatNO + "&seatShortNo=02" + self.seatNO + "&roomNo=101002&date=" + self._get_date_str()
